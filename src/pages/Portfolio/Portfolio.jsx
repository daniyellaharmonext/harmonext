...
const FEATURED = {
  ...
  problem: `Content creators are drowning in tools, tabs, and tasks. Despite the explosion of AI, most solutions add complexity rather than reducing it — leaving creators more burned out than before. This was conceived to solve a specific problem: how do you systematically build influence without systematic exhaustion?`,
  approach: `HarmoNext led the engagement from concept to shipped product. We started with a discovery sprint to validate the core value proposition with real creators, then built a product roadmap that sequenced MVP features by impact and technical feasibility. Our engineering team designed the system architecture and led full-stack development, while our PM and BA embedded with the founding team to manage scope, sprint execution, and stakeholder communication throughout.`,
  outcomes: [
