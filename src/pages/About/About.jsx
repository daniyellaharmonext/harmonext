...
const LEADERSHIP = [
  {
    ...
    photo: '/assets/IMG_8053 copy.jpg',
  },
  {
    name: 'Danielle',
  ...
  <>
    ...
    <section className={styles.missionSection}>
      <div className={`container ${styles.missionGrid}`}>
        <SectionReveal className={styles.cardReveal}>
        ...
        <SectionReveal delay={120} className={styles.cardReveal}>
          <div className={styles.missionCard}>
        ...
        <SectionReveal>
          <div className={styles.whyLayout}>
            <div className={styles.whyContent}>
              ...
              <p className={styles.whyText}>
                As a woman-owned consultancy, we also bring perspective that changes the quality
                of the questions asked — and by extension, the quality of the solutions designed.
              </p>
            </div>
            <div className={styles.whyImageWrap}>
              <img
                src="/assets/pexels-divinetechygirl-1181427.jpg"
    ...
    <section className={styles.valuesSection}>
      <div className={`container ${styles.valuesInner}`}>
        ...
        <div className={styles.valuesGrid}>
          {VALUES.map((val, i) => (
            <SectionReveal key={val.title} delay={i * 80} className={styles.cardReveal}>
      ...
      <div className={`container ${styles.teamInner}`}>
        <SectionReveal>
          ...
          <p className={styles.teamIntro}>
            Four disciplines. One integrated approach to delivery.
          </p>
        </SectionReveal>

        <div className={styles.teamGrid}>
          {LEADERSHIP.map((member, i) => (
            <SectionReveal key={member.name} delay={i * 90} className={styles.cardReveal}>
